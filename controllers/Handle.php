...
class Handle extends Controller
{
    ...
    public function callback(string $provider): RedirectResponse
    {
        ...
        /**
         * @event winter.sso.$provider.beforelogin
         * Fires before a session is generated by the AuthManager
         *
         * Example usage:
         *
        ...
        /**
         * @event winter.sso.$provider.afterlogin
         * Fires after a session is generated by the AuthManager
         *
         * Example usage:
         *
